...
# Sanity checks (quick)
req_cols <- c("cout_z","cin_z","stir_season_z","stir_cumall_z","volume_z","Treatment","Analyte","analyte_abbr","residue_prop")
...
d_mod <- d_mod %>%
  mutate(
    ...
    S = as.integer(as.factor(SampleMethod)),

    # Flume type index
    Fu = as.integer(as.factor(FlumeMethod)),
