...
---
Example:
  python code/pipeline/merge_wq_stir_by_season.py --wq out/kerbel_master_concentrations_long.csv --stir out/stir_events_long.csv --crops "data/crop records.csv" --out out --debug
