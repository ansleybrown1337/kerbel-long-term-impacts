#!/usr/bin/env python3
"""Regenerate v3p1 full-record products from validated saved CatBoost models.
...
from ml_catboost_conformal_loyo_v3p1_physical_event import main as ml_main
...
def main() -> None:
    ...
    forwarded = [
        str(Path(__file__).with_name("ml_catboost_conformal_loyo_v3p1_physical_event.py")),
        "--repo", str(repo),
        "--impute_only",
