...
"""Post-process the Kerbel v3p1 physical-event ML workflow.
...
def plot_event_unit_audit(output_dir: Path, figure_dir: Path) -> None:
    ...
    training_path = output_dir / "volume_observation_training_table_v3p1.csv"
...
def generate_figures(
    *,
    ...
    print("[DONE] v3p1 physical-event post-processing figures created.")
