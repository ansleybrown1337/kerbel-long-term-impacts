...
```bash
python code/pipeline/run_pipeline.py --debug
```
...
```bash
python code/pipeline/run_pipeline.py --debug --residue data/residue_myfield.csv
```

### Optional: skip residue merge
If you do not have residue data available yet:
```bash
python code/pipeline/run_pipeline.py --debug --skip-residue
```
...
**Script:** `code/pipeline/wq_longify.py`
...
**Script:** `code/pipeline/stir_pipeline.py`
