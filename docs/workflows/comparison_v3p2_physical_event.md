# Bayesian-versus-ML comparison v3p2

Active entry point: `code/comparison/bayes_ml_comparison_v3p2_physical_event.py`.

The comparison intentionally pairs completed Bayesian `v3p2_physical_event`
outputs with the still-current ML `v3p1_physical_event` outputs. It consumes
...
```powershell
& 'C:\Users\ansle\anaconda3\envs\wq_ml\python.exe' code\comparison\bayes_ml_comparison_v3p2_physical_event.py --repo . --skip-figures
& 'C:\Users\ansle\anaconda3\envs\wq_ml\python.exe' code\comparison\bayes_ml_comparison_v3p2_physical_event.py --repo . --figures-only
```

Inspect `results/comparison/v3p2_physical_event/run_manifest_comparison_v3p2_physical_event.json`,
raw tables before publication tables, and `figures/comparison/v3p2_physical_event/`.
