# Bayesian v3p2 prior audit

This audit records every prior-family decision changed or deliberately retained
when moving from Bayes v3p1 to v3p2. Predictors and modeled concentrations and
volumes are on their existing standardized scales unless noted otherwise.

## Changed priors

| Parameter or family | v3p1 | v3p2 | Reason |
|---|---:|---:|---|
...
v3p2 therefore treats this as an explicit prior specification to evaluate,
