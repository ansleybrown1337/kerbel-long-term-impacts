...
## Load Models (Vol + Concentration) – FINALIZED

**Current selected model:** `load1p7p5`  
**Stan file:** `code/m_stir_mogp_v1p7p5.stan`  
**Driver file:** `code/stir-bayes-load1p7p5.Rmd`  
**Status:** **FINAL – Converged and selected for inference**
...
| **1p7p5**  | **load1p7p5**  | Final latent-state formulation; stabilized non-centered parameterization; full MOGP; includes IRR as MVN by analyte     | **Converged**      | Selected final model |
...
Version **1p7p5** resolves prior geometric pathologies through:
