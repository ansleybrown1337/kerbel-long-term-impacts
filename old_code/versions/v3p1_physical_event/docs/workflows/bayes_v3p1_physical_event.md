...
Analyte-specific runoff-volume and irrigation coefficients retain scalar
...
`code/bayes/stir-bayes-load_v3p1_physical_event.R`. From Anaconda Prompt or
...
`Rscript code/bayes/diagnose_saved_fit_v3p1.R`; it writes parameter, chain,
