...
model {
  ...
  mu_beta_irr ~ normal(0, 0.3);
  sigma_beta_irr ~ exponential(2);
  z_beta_irr ~ std_normal();
  mu_beta_dup ~ normal(0, 0.3);
  sigma_beta_dup ~ exponential(2);
