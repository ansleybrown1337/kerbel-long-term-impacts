...
- Additive three-track figures place the unchanged Bayesian fit diagnostic, ML full-record reconstruction diagnostic, and ML outer-LOYO validation diagnostic side by side. LOYO is held-out prediction error, not an uncertainty interval.
